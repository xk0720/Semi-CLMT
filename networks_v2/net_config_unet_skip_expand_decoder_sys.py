class Swinv2Config():
    ...
    def __init__(
        ...
        embed_dim=96,
        depths=[2, 2, 6, 2],
        depths_decoder=[1, 2, 2, 2], # do not use
        num_heads=[3, 6, 12, 24],
        window_size=11,
        mlp_ratio=4.0,
        qkv_bias=True,
        ...
        **kwargs
        ...
        self.pretrained_window_sizes = (8, 8, 8, 8)
        self.depths_decoder = depths_decoder
        self.patches_resolution = [self.image_size // self.patch_size, self.image_size // self.patch_size]
        self.num_classes = 2
