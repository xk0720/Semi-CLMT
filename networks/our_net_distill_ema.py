...
from networks.resize_vision_transformer_ema import SwinUnet as ViT_seg
...
class Our_Net_distill(nn.Module):
    def __init__(self, img_size=352, num_classes=2):
        ...
        self.model = ViT_seg(config=None, img_size=img_size, num_classes=num_classes, drop_rate=0.5).cuda()     
